...
set(Qt5QuickControls2_VERSION_STRING 5.15.9)
...
function(_qt5_QuickControls2_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(_qt5_install_libs "${_qt5QuickControls2_install_prefix}/debug/lib/")
    else()
...
macro(_populate_QuickControls2_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5QuickControls2_install_prefix}/debug/lib/${LIB_LOCATION}")
    else()
    ...
    if(_static_deps)
        ...
        #message(STATUS "Target Qt5::QuickControls2 static links: ${_static_dep} through ${_static_dep_genex}") # Added for debugging
    endif()
    ...
    if(_static_link_flags)
        ...
        if(NOT CMAKE_VERSION VERSION_LESS "3.13")
            ...
            #message(STATUS "Target Qt5::QuickControls2 static link flags: ${_static_link_flags} through ${_static_link_flags_genex}")
        endif()
    endif()
...
if (NOT TARGET Qt5::QuickControls2)
    ...
    set(_Qt5QuickControls2_OWN_INCLUDE_DIRS "${_qt5QuickControls2_install_prefix}/include/qt5/" "${_qt5QuickControls2_install_prefix}/include/qt5/QtQuickControls2")
    set(Qt5QuickControls2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickControls2_install_prefix}/include/qt5/QtQuickControls2/5.15.9"
        "${_qt5QuickControls2_install_prefix}/include/qt5/QtQuickControls2/5.15.9/QtQuickControls2"
    )
    ...
    foreach(_module_dep ${_Qt5QuickControls2_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.9 ${_Qt5QuickControls2_FIND_VERSION_EXACT}
    ...
    if(EXISTS "${_qt5QuickControls2_install_prefix}/debug/lib/libQt5QuickControls2_debug.prl")
        _qt5_QuickControls2_process_prl_file(
            "${_qt5QuickControls2_install_prefix}/debug/lib/libQt5QuickControls2_debug.prl" DEBUG
            _Qt5QuickControls2_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5QuickControls2_STATIC_DEBUG_LINK_FLAGS
        )
    endif()

    if(EXISTS "${_qt5QuickControls2_install_prefix}/lib/libQt5QuickControls2.prl")
        _qt5_QuickControls2_process_prl_file(
    ...
    if (EXISTS
        "${_qt5QuickControls2_install_prefix}/debug/lib/libQt5QuickControls2_debug.a"
      AND EXISTS
        "${_qt5QuickControls2_install_prefix}/debug/lib/" )
        _populate_QuickControls2_target_properties(DEBUG "libQt5QuickControls2_debug.a" "" FALSE)
    endif()
    ...
    macro(_populate_QuickControls2_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        if("${Configuration}" STREQUAL "DEBUG")
            set(imported_location "${_qt5QuickControls2_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
        else()
