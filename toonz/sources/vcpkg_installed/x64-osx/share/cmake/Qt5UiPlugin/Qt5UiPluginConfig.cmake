...
function(_qt5_UiPlugin_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(_qt5_install_libs "${_qt5UiPlugin_install_prefix}/debug/lib/")
    else()
...
if (NOT TARGET Qt5::UiPlugin)
    ...
    set(_Qt5UiPlugin_OWN_INCLUDE_DIRS "${_qt5UiPlugin_install_prefix}/include/qt5/" "${_qt5UiPlugin_install_prefix}/include/qt5/QtUiPlugin")
    ...
    foreach(_module_dep ${_Qt5UiPlugin_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.9 ${_Qt5UiPlugin_FIND_VERSION_EXACT}
    ...
    if(EXISTS "${_qt5UiPlugin_install_prefix}/debug/lib/libQt5UiPlugin_debug.prl")
        _qt5_UiPlugin_process_prl_file(
            "${_qt5UiPlugin_install_prefix}/debug/lib/libQt5UiPlugin_debug.prl" DEBUG
            _Qt5UiPlugin_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5UiPlugin_STATIC_DEBUG_LINK_FLAGS
        )
    endif()

    if(EXISTS "${_qt5UiPlugin_install_prefix}/lib/libQt5UiPlugin.prl")
        _qt5_UiPlugin_process_prl_file(
    ...
    macro(_populate_UiPlugin_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        if("${Configuration}" STREQUAL "DEBUG")
            set(imported_location "${_qt5UiPlugin_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
        else()
