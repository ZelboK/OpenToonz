...
if (NOT TARGET Qt5::qmake)
    ...
    set(imported_location "${_qt5Core_install_prefix}/tools/qt5/bin/qmake")
...
if (NOT TARGET Qt5::moc)
    ...
    set(imported_location "${_qt5Core_install_prefix}/tools/qt5/bin/moc")
    _qt5_Core_check_file_exists(${imported_location})
...
if (NOT TARGET Qt5::rcc)
    ...
    set(imported_location "${_qt5Core_install_prefix}/tools/qt5/bin/rcc")
    _qt5_Core_check_file_exists(${imported_location})
...
set_property(TARGET Qt5::Core PROPERTY QT_DARWIN_MIN_DEPLOYMENT_TARGET "12")
