...
if(EXISTS "${_qt5Qml_install_prefix}/plugins/qmltooling/libqmldbg_server.prl")
...
if(EXISTS "${_qt5Qml_install_prefix}/debug/plugins/qmltooling/libqmldbg_server_debug.prl")
    _qt5_Qml_process_prl_file(
        "${_qt5Qml_install_prefix}/debug/plugins/qmltooling/libqmldbg_server_debug.prl" DEBUG
        _Qt5QQmlDebugServerFactory_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5QQmlDebugServerFactory_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5Qml_install_prefix}/plugins/qmltooling/libqmldbg_server.a")
    _populate_Qml_plugin_properties(QQmlDebugServerFactory RELEASE "qmltooling/libqmldbg_server.a" FALSE)
endif()
if(EXISTS "${_qt5Qml_install_prefix}/debug/plugins/qmltooling/libqmldbg_server_debug.a")
    _populate_Qml_plugin_properties(QQmlDebugServerFactory DEBUG "qmltooling/libqmldbg_server_debug.a" FALSE)
endif()
