...
if(EXISTS "${_qt5Qml_install_prefix}/plugins/qmltooling/libqmldbg_preview.prl")
...
if(EXISTS "${_qt5Qml_install_prefix}/debug/plugins/qmltooling/libqmldbg_preview_debug.prl")
    _qt5_Qml_process_prl_file(
        "${_qt5Qml_install_prefix}/debug/plugins/qmltooling/libqmldbg_preview_debug.prl" DEBUG
        _Qt5QQmlPreviewServiceFactory_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5QQmlPreviewServiceFactory_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5Qml_install_prefix}/plugins/qmltooling/libqmldbg_preview.a")
    _populate_Qml_plugin_properties(QQmlPreviewServiceFactory RELEASE "qmltooling/libqmldbg_preview.a" FALSE)
endif()
if(EXISTS "${_qt5Qml_install_prefix}/debug/plugins/qmltooling/libqmldbg_preview_debug.a")
    _populate_Qml_plugin_properties(QQmlPreviewServiceFactory DEBUG "qmltooling/libqmldbg_preview_debug.a" FALSE)
endif()
...
set_property(TARGET Qt5::QQmlPreviewServiceFactory APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::Quick;Qt5::Qml;Qt5::PacketProtocol;Qt5::Gui;Qt5::Gui;Qt5::Core;Qt5::Network;Qt5::Core"
)
