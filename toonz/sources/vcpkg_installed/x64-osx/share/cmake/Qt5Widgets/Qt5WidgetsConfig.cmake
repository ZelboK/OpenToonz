...
set(Qt5Widgets_VERSION_STRING 5.15.9)
...
function(_qt5_Widgets_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(_qt5_install_libs "${_qt5Widgets_install_prefix}/debug/lib/")
    else()
...
macro(_populate_Widgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5Widgets_install_prefix}/debug/lib/${LIB_LOCATION}")
    else()
    ...
    if(_static_deps)
        ...
        #message(STATUS "Target Qt5::Widgets static links: ${_static_dep} through ${_static_dep_genex}") # Added for debugging
    endif()
    ...
    if(_static_link_flags)
        ...
        if(NOT CMAKE_VERSION VERSION_LESS "3.13")
            ...
            #message(STATUS "Target Qt5::Widgets static link flags: ${_static_link_flags} through ${_static_link_flags_genex}")
        endif()
    endif()
...
if (NOT TARGET Qt5::Widgets)
    ...
    set(Qt5Widgets_PRIVATE_INCLUDE_DIRS
        "${_qt5Widgets_install_prefix}/include/qt5/QtWidgets/5.15.9"
        "${_qt5Widgets_install_prefix}/include/qt5/QtWidgets/5.15.9/QtWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5Widgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.9 ${_Qt5Widgets_FIND_VERSION_EXACT}
    ...
    if(EXISTS "${_qt5Widgets_install_prefix}/debug/lib/libQt5Widgets_debug.prl")
        _qt5_Widgets_process_prl_file(
            "${_qt5Widgets_install_prefix}/debug/lib/libQt5Widgets_debug.prl" DEBUG
            _Qt5Widgets_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5Widgets_STATIC_DEBUG_LINK_FLAGS
        )
    endif()

    if(EXISTS "${_qt5Widgets_install_prefix}/lib/libQt5Widgets.prl")
        _qt5_Widgets_process_prl_file(
    ...
    set_property(TARGET Qt5::Widgets
                 ...
                 widgettextcontrol;effects;style-fusion;style-mac;style-windows)
    set_property(TARGET Qt5::Widgets
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 gtk3;style-android;style-windowsvista)
    ...
    if (EXISTS
        "${_qt5Widgets_install_prefix}/debug/lib/libQt5Widgets_debug.a"
      AND EXISTS
        "${_qt5Widgets_install_prefix}/debug/lib/" )
        _populate_Widgets_target_properties(DEBUG "libQt5Widgets_debug.a" "" FALSE)
    endif()
