...
if(EXISTS "${_qt5Network_install_prefix}/plugins/bearer/libqgenericbearer.prl")
...
if(EXISTS "${_qt5Network_install_prefix}/debug/plugins/bearer/libqgenericbearer_debug.prl")
    _qt5_Network_process_prl_file(
        "${_qt5Network_install_prefix}/debug/plugins/bearer/libqgenericbearer_debug.prl" DEBUG
        _Qt5QGenericEnginePlugin_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5QGenericEnginePlugin_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5Network_install_prefix}/plugins/bearer/libqgenericbearer.a")
    _populate_Network_plugin_properties(QGenericEnginePlugin RELEASE "bearer/libqgenericbearer.a" FALSE)
endif()
if(EXISTS "${_qt5Network_install_prefix}/debug/plugins/bearer/libqgenericbearer_debug.a")
    _populate_Network_plugin_properties(QGenericEnginePlugin DEBUG "bearer/libqgenericbearer_debug.a" FALSE)
endif()
