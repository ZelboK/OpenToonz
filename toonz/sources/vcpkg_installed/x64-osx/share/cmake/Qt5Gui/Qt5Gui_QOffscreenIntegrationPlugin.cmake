...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/platforms/libqoffscreen.prl")
...
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/platforms/libqoffscreen_debug.prl")
    _qt5_Gui_process_prl_file(
        "${_qt5Gui_install_prefix}/debug/plugins/platforms/libqoffscreen_debug.prl" DEBUG
...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/platforms/libqoffscreen.a")
    _populate_Gui_plugin_properties(QOffscreenIntegrationPlugin RELEASE "platforms/libqoffscreen.a" FALSE)
endif()
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/platforms/libqoffscreen_debug.a")
    _populate_Gui_plugin_properties(QOffscreenIntegrationPlugin DEBUG "platforms/libqoffscreen_debug.a" FALSE)
endif()
