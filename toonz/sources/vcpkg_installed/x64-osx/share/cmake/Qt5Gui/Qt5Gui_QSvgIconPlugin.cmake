...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/iconengines/libqsvgicon.prl")
...
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/iconengines/libqsvgicon_debug.prl")
    _qt5_Gui_process_prl_file(
        "${_qt5Gui_install_prefix}/debug/plugins/iconengines/libqsvgicon_debug.prl" DEBUG
        _Qt5QSvgIconPlugin_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5QSvgIconPlugin_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/iconengines/libqsvgicon.a")
    _populate_Gui_plugin_properties(QSvgIconPlugin RELEASE "iconengines/libqsvgicon.a" FALSE)
endif()
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/iconengines/libqsvgicon_debug.a")
    _populate_Gui_plugin_properties(QSvgIconPlugin DEBUG "iconengines/libqsvgicon_debug.a" FALSE)
endif()
