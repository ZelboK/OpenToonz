...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/imageformats/libqtiff.prl")
...
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqtiff_debug.prl")
    _qt5_Gui_process_prl_file(
        "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqtiff_debug.prl" DEBUG
        _Qt5QTiffPlugin_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5QTiffPlugin_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/imageformats/libqtiff.a")
    _populate_Gui_plugin_properties(QTiffPlugin RELEASE "imageformats/libqtiff.a" FALSE)
endif()
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqtiff_debug.a")
    _populate_Gui_plugin_properties(QTiffPlugin DEBUG "imageformats/libqtiff_debug.a" FALSE)
endif()
