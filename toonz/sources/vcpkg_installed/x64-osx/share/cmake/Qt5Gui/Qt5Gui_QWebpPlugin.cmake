...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/imageformats/libqwebp.prl")
...
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqwebp_debug.prl")
    _qt5_Gui_process_prl_file(
        "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqwebp_debug.prl" DEBUG
        _Qt5QWebpPlugin_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5QWebpPlugin_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/imageformats/libqwebp.a")
    _populate_Gui_plugin_properties(QWebpPlugin RELEASE "imageformats/libqwebp.a" FALSE)
endif()
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqwebp_debug.a")
    _populate_Gui_plugin_properties(QWebpPlugin DEBUG "imageformats/libqwebp_debug.a" FALSE)
endif()
