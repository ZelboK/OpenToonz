...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/platforms/libqcocoa.prl")
...
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/platforms/libqcocoa_debug.prl")
    _qt5_Gui_process_prl_file(
        "${_qt5Gui_install_prefix}/debug/plugins/platforms/libqcocoa_debug.prl" DEBUG
        _Qt5QCocoaIntegrationPlugin_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5QCocoaIntegrationPlugin_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/platforms/libqcocoa.a")
    _populate_Gui_plugin_properties(QCocoaIntegrationPlugin RELEASE "platforms/libqcocoa.a" FALSE)
endif()
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/platforms/libqcocoa_debug.a")
    _populate_Gui_plugin_properties(QCocoaIntegrationPlugin DEBUG "platforms/libqcocoa_debug.a" FALSE)
endif()
