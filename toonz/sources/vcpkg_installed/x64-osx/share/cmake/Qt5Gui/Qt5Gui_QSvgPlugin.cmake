...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/imageformats/libqsvg.prl")
...
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqsvg_debug.prl")
    _qt5_Gui_process_prl_file(
        "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqsvg_debug.prl" DEBUG
...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/imageformats/libqsvg.a")
    _populate_Gui_plugin_properties(QSvgPlugin RELEASE "imageformats/libqsvg.a" FALSE)
endif()
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqsvg_debug.a")
    _populate_Gui_plugin_properties(QSvgPlugin DEBUG "imageformats/libqsvg_debug.a" FALSE)
endif()
...
string(CONCAT _plugin_genex
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QSvgPlugin,QT_PLUGIN_EXTENDS>,Qt::Gui>,"
