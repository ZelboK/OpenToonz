...
set(_Qt5AVFMediaPlayerServicePlugin_MODULE_DEPENDENCIES "Multimedia;MultimediaWidgets;Gui;Network;Core")
...
if(EXISTS "${_qt5Multimedia_install_prefix}/plugins/mediaservice/libqavfmediaplayer.prl")
...
if(EXISTS "${_qt5Multimedia_install_prefix}/debug/plugins/mediaservice/libqavfmediaplayer_debug.prl")
    _qt5_Multimedia_process_prl_file(
        "${_qt5Multimedia_install_prefix}/debug/plugins/mediaservice/libqavfmediaplayer_debug.prl" DEBUG
...
if(EXISTS "${_qt5Multimedia_install_prefix}/plugins/mediaservice/libqavfmediaplayer.a")
    _populate_Multimedia_plugin_properties(AVFMediaPlayerServicePlugin RELEASE "mediaservice/libqavfmediaplayer.a" FALSE)
endif()
if(EXISTS "${_qt5Multimedia_install_prefix}/debug/plugins/mediaservice/libqavfmediaplayer_debug.a")
    _populate_Multimedia_plugin_properties(AVFMediaPlayerServicePlugin DEBUG "mediaservice/libqavfmediaplayer_debug.a" FALSE)
endif()
...
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::AVFMediaPlayerServicePlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
string(CONCAT _plugin_genex
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<NOT:$<IN_LIST:Qt::AVFMediaPlayerServicePlugin,${_no_plugins_genex}>>"
        ">"
...
set_property(TARGET Qt5::AVFMediaPlayerServicePlugin APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::Multimedia;Qt5::MultimediaWidgets;Qt5::Gui;Qt5::Network;Qt5::Core"
)
